...
async function seedDatabase() {
    ...
    try {
        const flagRef = doc(db, 'appData', 'isSeeded');
        ...
        // 4. Set the flag to prevent re-seeding
        batch.set(flagRef, { value: true });
...
export default async function Page() {
    const t = await getTranslations('PageError');
            ...
            <div className="flex items-center justify-center min-h-screen p-4">
                <div className="w-full max-w-2xl p-8 text-center text-red-200 bg-red-900/50 rounded-lg shadow-lg glassmorphic border border-red-500">
                    ...
                    <ul className="text-left list-disc list-inside mb-6 space-y-2">
                        <li dangerouslySetInnerHTML={{ __html: t('check1') }} />
                        <li dangerouslySetInnerHTML={{ __html: t('check2') }} />
                        <li dangerouslySetInnerHTML={{ __html: t('check3') }} />
                    </ul>
